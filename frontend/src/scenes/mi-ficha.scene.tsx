            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder={t("scenes.characterSheet.basicInfo.namePlaceholder")}
                  />
                </div>
                <div>
                  ...
                  <Select value={race} onValueChange={setRace}>
                    <SelectTrigger id="race">
                      <SelectValue placeholder={t("scenes.characterSheet.basicInfo.racePlaceholder")} />
                    </SelectTrigger>
                    <SelectContent>
                      {DND_RACES.map((r) => (
                    ...
                    <div className="flex-1">
                      ...
                      >
                        <SelectTrigger id={`class-${index}`}>
                          <SelectValue placeholder={t("scenes.characterSheet.basicInfo.classPlaceholder")} />
                        </SelectTrigger>
                        <SelectContent>
                          {DND_CLASSES.map((c) => (
                ...
                <div>
                  ...
                  <Select value={background} onValueChange={setBackground}>
                    <SelectTrigger id="background">
                      <SelectValue placeholder={t("scenes.characterSheet.basicInfo.backgroundPlaceholder")} />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder={t("scenes.characterSheet.basicInfo.personalityPlaceholder")}
                  rows={3}
                />
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder={t("scenes.characterSheet.basicInfo.idealsPlaceholder")}
                    rows={3}
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder={t("scenes.characterSheet.basicInfo.bondsPlaceholder")}
                    rows={3}
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder={t("scenes.characterSheet.basicInfo.flawsPlaceholder")}
                    rows={3}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder={t("scenes.characterSheet.basicInfo.languagesPlaceholder")}
                  />
                </div>
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue placeholder={t("scenes.characterSheet.basicInfo.proficienciesPlaceholder")} />
                      </SelectTrigger>
                      <SelectContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder={t("scenes.characterSheet.combat.hitDicePlaceholder")}
                  />
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            ...
            <CardContent>
              <Textarea
                ...
                placeholder={t("scenes.characterSheet.skills.featuresPlaceholder")}
                rows={8}
              />
            </CardContent>
          </Card>
